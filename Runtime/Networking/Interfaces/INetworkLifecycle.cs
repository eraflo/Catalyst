namespace Eraflo.Catalyst.Networking
{
    ...
    public interface INetworkLifecycle
    {
        ...
        bool StartServer(ushort port, NetworkTransportType transport = NetworkTransportType.UDP);
        ...
        bool StartHost(ushort port, NetworkTransportType transport = NetworkTransportType.UDP);
